    ...
    <div {...useBlockProps()}>
      <InspectorControls>
        <PanelBody title="People Directory Settings" initialOpen={true}>
          ...
          attributes.tag.length > 0 ||
          attributes.profile_order !== "" ? (
            <div className="uams-people-list-block__data-source-notice notice notice-warning">
              <p>
          ...
          {attributes.data_source === "custom" &&
            !isValidUrl(attributes.custom_data_source) && (
              <div className="uams-people-list-block__data-source-notice notice notice-error notice-alt">
      ...
      <div className="uams-gutenberg-people-list">
        {attributes.filters.length > 0 && (
          <div className="uams-gutenberg-people-list__filters">
            {attributes.filters
              .filter((f) => f !== "search")
              .map((filter, index) => (
                <div
                ...
                >
                  {attributes[filter + "_filter_label"] ||
                    "Filter by " + filter}
                  <span className="uams-gutenberg-people-list__filter-icon dashicons dashicons-arrow-down-alt2"></span>
                </div>
              ))}
            ...
            {attributes.filters.includes("search") && (
              ...
              >
                ...
                <span className="uams-gutenberg-people-list__filter-icon dashicons dashicons-search"></span>
              </div>
            )}
          </div>
        )}
          ...
          {[...Array(attributes.columns)].map((e, i) => (
            ...
            >
              {attributes.display_fields.includes("photo") && (
                <div className="uams-gutenberg-people-list__profile-image"></div>
              )}

              <div className="uams-gutenberg-people-list__profile-content">
                {attributes.display_fields.includes("name") && (
                  <h2 className="uams-gutenberg-people-list__profile-name">
                    Person Name
                  </h2>
                )}

                {attributes.display_fields.includes("title") && (
                  <div className="uams-gutenberg-people-list__profile-title">
                    Position Title
                  </div>
                )}

                {attributes.display_fields.includes("email") && (
                  <div className="dashicons-before dashicons-email-alt uams-gutenberg-people-list__profile-icon-text">
                    <span>butch.cougar@wsu.edu</span>
                  </div>
                )}

                {attributes.display_fields.includes("office") && (
                  <div className="dashicons-before dashicons-location uams-gutenberg-people-list__profile-icon-text">
                    <span>Office Location</span>
                  </div>
                )}

                {attributes.display_fields.includes("phone") && (
                  <div className="dashicons-before dashicons-phone uams-gutenberg-people-list__profile-icon-text">
                    <span>555-555-5555</span>
                  </div>
                )}

                {attributes.display_fields.includes("website") && (
                  <div className="dashicons-before dashicons-admin-links uams-gutenberg-people-list__profile-icon-text">
        ...
        <h3 className="uams-gutenberg-people-list__names-label">
        ...
        {!loading && profiles.length > 0 && (
          <>
            <ol className="uams-gutenberg-people-list__names">
        ...
        {/* {profiles.map((p, index) =>
          <div className="uams-gutenberg-people-list__profile" key={index}>
