...
const TermSelector = function (props) {
  ...
  return (
    <div className="uams-gutenberg-people-list-term-selector">
      {isLoading && <Spinner />}
      ...
      {selectedTerms.length > 0 && (
        <ul className="uams-gutenberg-people-list-term-selector__selected_terms">
          {selectedTerms.map((term, index) => {
            return (
              ...
              >
                ...
                >
                  <span className="uams-gutenberg-people-list-term-selector__remove-btn-text">
                    {term.name}
                  </span>
                  <span className="dashicon dashicons dashicons-no-alt uams-gutenberg-people-list-term-selector__remove-btn-icon"></span>
                </button>
              </li>
            );
          })}
