...
class Block_UAMSWP_News extends Block {

	protected static $block_name    = 'uamswp/news';
	...
	public static function render( $attrs, $content = '' ) {
		...
		$card_classes = 'uams-card uams-card-news';

		$wrapper_classes = 'uams-card__wrapper';

		static::add_class( $card_classes, '', 'className', $attrs );

		static::add_class( $card_classes, 'uams-card-', 'type', $attrs );

		static::add_class( $wrapper_classes, 'uams-card__wrapper-', 'type', $attrs );

		static::add_class( $wrapper_classes, 'uams-per-row--', 'perRow', $attrs );
