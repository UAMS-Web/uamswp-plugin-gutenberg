...
const CardPlaceholder = ( props ) => {
	...
	return (
		<div className="uams-card uams-news-card uams-card--placeholder">
			<div className="uams-image-frame  uams-image-frame--fixed-ratio">
			</div>
			<div className="uams-card__content">
				<div className="uams-title">
					Lorem ipsum dolor sit amet
				</div>
				<div className="uams-caption">
...
const IndexPlaceholder = ( props ) => {
	...
	return (
		<div className="uams-card uams-news-card uams-card--placeholder uams-card--horizontal">
			<div className="uams-card__content">
				<div className="uams-title">
					Lorem ipsum dolor sit amet
				</div>
...
const ListPlaceholder = ( props ) => {
	...
	<div className="uams-card uams-news-card uams-card--placeholder uams-card--horizontal uams-card--small">
		<div className="uams-card__content">
			<div className="uams-title">
				Lorem ipsum dolor sit amet
			</div>
