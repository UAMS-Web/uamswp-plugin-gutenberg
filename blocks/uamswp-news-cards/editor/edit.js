...
const FeedPlaceHolder = () => {
    ...
    return (
        <span className="uams-card-news__placeholder">
            <span className="uams-card-news__placeholder-message">No Cards Found</span>
            <span className="uams-card-news__placeholder-text">Try changing your feed settings!</span>
        </span>
    )
