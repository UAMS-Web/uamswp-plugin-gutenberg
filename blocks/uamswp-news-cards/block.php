...
class Block_UAMSWP_News_Cards extends Block {

	protected static $block_name    = 'uamswp/news-cards';
	protected static $default_attrs = array(
		'className'         => 'uams-card-wrapper uams-card-wrapper--news',
		'source'            => 'feed',
	...
	public static function render( $attrs, $content = '' ) {
		...
		static::add_class( $attrs['className'], 'uams-card-wrapper--per-row-', 'perRow', $attrs );
