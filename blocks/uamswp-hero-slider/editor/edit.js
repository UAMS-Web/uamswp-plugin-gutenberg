  ...
  return (
    <>
      ...
      <div {...blockProps} data-selected-slide-index={selectedSlideIndex}>
        <div className="uams-gutenberg-hero-slider__slides">
          <InnerBlocks
            template={[
              [
                "uamswp/hero",
        ...
        {slideBlocks && (
          <div className="uams-gutenberg-hero-slider__controls">
            {slideBlocks.map((b, i) => (
              <div
                key={`slide-${i}`}
                className={`uams-gutenberg-hero-slider__control-container${
                  selectedSlideIndex === i ? " is-selected" : ""
                }`}
              >
                {/* TODO: Disable/hide specific buttons when actions not allowed */}
                {slideBlocks.length > 1 && (
                  <div className="uams-gutenberg-hero-slider__sub-controls">
                    <ButtonGroup className="uams-gutenberg-hero-slider__sub-controls-group">
                      <Button
                        showTooltip={true}
                        label="Move Left"
