...
const edit = (props) => {
  ...
  return (
    <>
          ...
          <PanelRow>
            <BaseControl className="uams-settings__base-control" help="">
              ...
              <RadioGroup
                ...
                checked={getBlockClassNameValue(attributes, "uams-cta--width-")}
                defaultChecked=""
              >
      ...
      <BlockControls>
        <AlignmentToolbar
          value={getBlockClassNameValue(attributes, "uams-text-align--")}
          onChange={(val) =>
            setBlockClassName(
              attributes,
              setAttributes,
      ...
      <div {...blockProps}>
        <a className={"uams-button " + attributes.buttonClassName}>
          {attributes.iconBefore && (
            <i className={`uams-icon uams-i-${attributes.iconBefore}`}></i>
          )}
          <RichText
            allowedFormats={[]}
          ...
          {attributes.iconAfter && (
            <i className={`uams-icon uams-i-${attributes.iconAfter}`}></i>
          )}
        </a>
      </div>
    </>
