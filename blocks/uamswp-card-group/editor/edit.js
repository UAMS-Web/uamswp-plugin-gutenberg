...
const Edit = ( props ) => {
	...
	let blockClasses = [
		'uams-card-wrapper',
		'uams-card-wrapper--per-row-' + attributes.columns,
	]
		...
		<InspectorControls>
			...
			<PanelColorOptions>
				<ColorClassControl
					...
					value={ getBlockClassNameValue( attributes,'uams-color-background--', '', 'cardClassName' ) }
					onSetColor={ ( color ) => {
						setChildBlockClassName( clientId, 'uams-color-background--', color );
						setBlockClassName( attributes, setAttributes, 'uams-color-background--', color, 'cardClassName' );
					} }
					/>
				<ColorClassControl
					{ ...props }
					colors={borderColors}
					label='Border Color'
					value={ getBlockClassNameValue( attributes,'uams-border-top--color-', '', 'cardClassName' ) }
					onSetColor={ ( color ) => {
						setChildBlockClassName( clientId, 'uams-border-top--color-', color );
						setBlockClassName( attributes, setAttributes, 'uams-border-top--color-', color, 'cardClassName' );
					}}
					/>
			</PanelColorOptions>
			<SpacingClassNameSelector
					...
					checked={ hasBlockClassName( attributes, 'uams-card-group--spacing-none' ) }
					onChange={ ( collapseSpacing ) => setBlockClassNameBool( attributes, setAttributes, 'uams-card-group--spacing-none', collapseSpacing ) }
					/>				
				</SpacingClassNameSelector>
		</InspectorControls>
		<InspectorAdvancedControls>
