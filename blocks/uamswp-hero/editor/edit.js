		...
		<>
			<InspectorControls>
				...
				<PanelDisplayOptions>
					<SelectControl
						label="Height"
						value={ getBlockClassNameValue( blockClasses, 'uams-hero--size-' ) }
						options={ [
							{ label: 'Default', value: '' },
						...
						onChange={ ( size ) => { setAttributes( { className: addBlockClassName( blockClasses, 'uams-hero--size-', size ) } ) } }
					/>
					<SelectControl
						label="Overlay"
					...
					<PanelBody title="Background" initialOpen={false}>
						...
						{attributes.backgroundType === 'slider' && (
							<>
								...
								<BaseControl className="uams-settings__base-control" help="Effect used when transitioning to the next slide.">
									<BaseControl.VisualLabel className="uams-settings__label">
										Effect
									</BaseControl.VisualLabel>
									<RadioGroup
			...
			<div { ...blockProps } >
				<div className="uams-image-frame uams-image-frame--fill">
				...
				<div className="uams-hero__content">
					<div className="uams-hero__caption">
						<RichText
						...
						/>
						{ attributes.link && attributes.buttonText && <span className="uams-button uams-button--size-small" href="#" aria-labelledby="unique-id-hero-banner-title">{ attributes.buttonText }</span> }
					</div>
				</div>
			</div>
		</>
