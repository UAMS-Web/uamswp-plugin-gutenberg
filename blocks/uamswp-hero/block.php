...
class Block_UAMSWP_Hero extends Block {

	protected static $block_name    = 'uamswp/hero';
	protected static $default_attrs = array(
		'className'         => 'uams-hero uams-width--full uams-pattern--uams-light-radial-left',
		'requiredClassName' => '',
		'imageSize'         => 'full',
		'imageId'           => '0',
		'imageSrc'          => '',
		...
		'photoCredit'       => '',
		'lightOverlay'      => false,
		'pattern'           => 'uams-light-radial-left',
		'overlay'           => 'dark-left',
	...
	public static function render( $attrs, $content = '' ) {
		...
		$overlay_classes = 'uams-overlay uams-pattern-after';

		static::add_class( $overlay_classes, 'uams-overlay--', 'overlay', $attrs );
		static::add_class( $overlay_classes, 'uams-pattern--', 'pattern', $attrs );

		ob_start();

		if ( false !== strpos( $attrs['className'], 'uams-style--boxed' ) ) {
