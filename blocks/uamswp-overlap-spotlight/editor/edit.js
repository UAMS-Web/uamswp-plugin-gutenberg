		...
		<>
			...
			<div { ...blockProps }>
				<div className="uams-overlap__container">
					<div className={'uams-overlap__column uams-overlap--overlap-' + attributes.overlap }>
						<div className="uams-overlap__column-inner">
							<div className="uams-overlap-spotlight__image">
								<div className="uams-image-frame">
									<ImageFrameControl { ...props } />
								</div>
							</div>
						</div>
					</div>
					<div className={'uams-overlap__column uams-overlap--surface-column uams-overlap--overlap-' + attributes.overlap }>
						<div className="uams-overlap__column-inner">
							<div className={'uams-overlap-spotlight__caption ' + attributes.captionClasses }>
								<InnerBlocks
									templateLock={ false }
								/>
							</div>
