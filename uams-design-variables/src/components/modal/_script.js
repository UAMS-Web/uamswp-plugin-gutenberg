class UamsModal {
    ...
    clickEvents(event) {
        try {
            ...
            let modal = document.querySelector(".uams-modal");
            let openButton = document.getElementById("open-modal");
            let closeButton = document.querySelector(".uams-modal__close-button");
            ...
            if (eventElement === openButton) {
                if (modal.classList.contains(".modal-open") === false) {
                    ...
                    modal.classList.toggle("uams-modal__closed");
    ...
    keyDownEvents(event) {
        ...
        try {
            ...
            modal.addEventListener("keydown", function (e) {
                ...
                if (isEscPressed) {
                    modal.querySelector("button.uams-modal__close-button").click();
                }
            });
        } catch (error) {
            console.error(error);
