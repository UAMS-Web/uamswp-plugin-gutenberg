...
class UamsMenu {
    ...
    clickEvents( event ) {
		...
		try {
            ...
            // Toggle Action
            if ( eventElement.classList.contains( 'uams-menu--toggle' ) ) {
            ...
            if ( eventElement.classList.contains( 'uams-menu--submenu-close' ) ) {
    ...
    open( navElement ) {
        ...
        subMenu.classList.add( 'uams-animate--slide-down' );
        ...
        this.timer = setTimeout(
            function() {
                ...
                subMenu.classList.remove( 'uams-animate--slide-down' );
            }, 
            500
        );
    ...
    close( navElement ) {
        ...
        setTimeout(
            function() {
                ...
                subMenu.classList.add( 'uams-animate--slide-up' );
        ...
        this.timer = setTimeout(
            function() {
                subMenu.style.maxHeight = '';
                subMenu.classList.remove( 'uams-animate--slide-up' );
            }, 
            500
        );
