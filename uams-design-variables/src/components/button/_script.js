class UamsButton {
    ...
    clickEvents( event ) {
        ...
        try {
            ...
            if ( event.target.classList.contains( 'uams-button-pause-background' ) ) {

                this.toggleActiveButton( event.target, 'uams-button-pause-background', ['Pause','Play'] )
            }
