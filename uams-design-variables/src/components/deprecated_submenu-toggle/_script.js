class UamsSubmenuToggle {

    constructor( props = {} ) {

        this.class            = ( props.hasOwnProperty( 'class') ) ? props.class : 'uams-submenu';
        ...
        this.animatingClass   = ( props.hasOwnProperty( 'animatingClass') ) ? props.animatingClass : 'uams-animating';
    ...
    isAnimating( parentElement ) {
        ...
        this.timer = setTimeout( () => {
            ...
            parentElement.classList.remove('uams-animating');
...
export default UamsSubmenuToggle;