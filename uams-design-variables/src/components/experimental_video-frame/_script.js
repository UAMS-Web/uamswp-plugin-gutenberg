class UamsVideoFrame {

    constructor( atts = {} ) {

        this.bassClass = 'uams-video-frame';
    ...
    clickEvents( event ) {
        ...
        try {
            ...
            if ( event.target.classList.contains( 'uams-video-frame--action-play' ) ) {
            ...
            if ( event.target.classList.contains( 'uams-video-frame--action-toggle-background' ) ) {
    ...
    playVideo( videoWrapper ) {
        ...
        let video = videoWrapper.getElementsByClassName('uams-video-frame__video-background');
        ...
        if ( video.length ) {
            ...
            video.classList.add('uams-video-frame__video');

            video.classList.remove('uams-video-frame__video-background');
    ...
    toggleBackgroundVideo( element ) {
        ...
        if ( ! video.length ) {
            ...
            console.log('UAMS Video Frame: Video Not Found');
    ...
    setVideoSize() {
        ...
        let videos = document.getElementsByClassName('uams-video-frame__video-background');
