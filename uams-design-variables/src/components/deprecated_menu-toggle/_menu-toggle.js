/*import UamsToggleMenu from "../../../_assets/js/uamsToggleMenu";

const uamsMenuToggle = new UamsToggleMenu( { clickClass: 'uams-menu-toggle--toggle', toggleHeight: true } );

export default uamsMenuToggle;*/
...
class UamsMenuToggle {

    constructor( atts = {} ) {

        this.baseClass        = ( atts.hasOwnProperty( 'baseClass') ) ? atts.baseClass : 'uams-menu-toggle';
